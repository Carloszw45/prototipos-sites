...
|---|---|---|---|---|---|
| SB-001 | Hero / mobile | Confirmar densidade, entrada/saída dos textos e sobreposição com o burger nos dois sentidos do scroll. | PUBLICADO | `8eef194678adddbedc51b5e8ff33b559ed2e1da1` | revisões zeradas após correção visual |
